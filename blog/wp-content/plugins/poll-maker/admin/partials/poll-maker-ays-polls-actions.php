...
$default_options = array(
    ...
    'show_chart_type' => 'default_bar_chart',
);
    ...
    <div class="container-fluid">
        <form class="ays-poll-form" id="ays-poll-form" method="post">
            ...
            <div id="tab1" class="ays-poll-tab-content <?= $active_tab == 'General' ? 'ays-poll-tab-content-active' : ''; ?>">
                ...
                <hr>
                <?php endif; ?>
                <div class="ays-field form-group" style="display: flex;">
                    <div class="col-sm-4">
                ...
                <div class="if-choosing poll-type-block form-group ays-poll-type-block">
                    ...
                    <div class="col-sm-9">
                        <div class="form-group row ays-poll-type-block ays-poll-answers-redirect-alignment">
                            <div class="col-sm-2">
            ...
            <div id="tab8" class="ays-poll-tab-content <?= $active_tab == 'Results Settings' ? 'ays-poll-tab-content-active' : ''; ?>">
                ...
                <div class="form-group row ays_toggle_parent">
                    ...
                    <div class="col-sm-8 ays_toggle_target ays_divider_left <?php echo $options['hide_results'] ? '' : 'display_none'; ?>">
                    	<div class="form-group row">
                    		<div class="col-sm-4">
                ...
                <div class="form-group row ays_toggle_parent">
                    ...
                    <div class="col-sm-8 ays_toggle_target ays_divider_left <?php echo $enable_social_links ? '' : 'display_none' ?>">
                    	<div class="form-group row">
                            <div class="col-sm-4">
                                <label>
                                ...
                                <label class='ays-poll-dblclick-layer'>
                                    ...
                                    <div class="ays_poll_layer_item" >
                                        ...
                                        <div class="ays_poll_layer_item_title">
                                            ...
                                            <a class="ays_poll_view_demo_link" href="https://poll-plugin.com/image-choosing/" style="font-size:15px;" target="_blank">View demo</a>
                                ...
                                <label class='ays-poll-dblclick-layer'>
                                    ...
                                    <div class="ays_poll_layer_item">
                                        ...
                                        <div class="ays_poll_layer_item_title">
                                            ...
                                            <a class="ays_poll_view_demo_link" href="https://poll-plugin.com/rating-polls-rating-type/" style="font-size:15px;" target="_blank">View demo</a>
                                            <i class="ays_poll_fas ays_poll_fa_play" aria-hidden="true"></i>
                                        </div>
                                        <div class="ays_poll_layer_item_description"></div>
                                    </div>
                                ...
                                <label class='ays-poll-dblclick-layer'>
                                    ...
                                    <div class="ays_poll_layer_item">
                                        ...
                                        <div class="ays_poll_layer_item_title">
                                            ...
                                            <a class="ays_poll_view_demo_link" href="https://poll-plugin.com/voting-polls-voting-type/" style="font-size:15px;" target="_blank">View demo</a>
                                            <i class="ays_poll_fas ays_poll_fa_play" aria-hidden="true"></i>
                                        </div>
                                        <div class="ays_poll_layer_item_description"></div>  
                                    </div>
                                    ...
                                    <div class="ays_poll_layer_item">
                                     ...
                                     alt="<?= __('Text', $this->plugin_name) ?>">
                                        ...
                                        <div class="ays_poll_layer_item_title">
                                            ...
                                            <a class="ays_poll_view_demo_link" href="https://poll-plugin.com/open-ended-question-polls-text-type/" style="font-size:15px;" target="_blank">View demo</a>
                                            <i class="ays_poll_fas ays_poll_fa_play" aria-hidden="true"></i>
                                        </div>
                                        <div class="ays_poll_layer_item_description"></div>  
                                    </div>
                                    ...
                                    <div class="ays_poll_layer_item">
                                     ...
                                     alt="<?= __('Dropdown', $this->plugin_name) ?>">
                                        ...
                                        <div class="ays_poll_layer_item_title">
                                            ...
                                            <p>
                                            <!-- <a href="https://bit.ly/3P42n1R" style="font-size:12px;font-style: italic;" target="_blank">View demo</a> -->
                                            <a class="ays_poll_view_demo_link" href="https://poll-plugin.com/anonymous-polls-dropdown-type/" style="font-size:15px;" target="_blank">View demo</a>
                                            <i class="ays_poll_fas ays_poll_fa_play" aria-hidden="true"></i>
                                        </div>
                                        <div class="ays_poll_layer_item_description"></div>  
                                    </div>
                                ...
                                <label class='ays-poll-dblclick-layer ays-poll-type-pro-feature'>
                                    ...
                                    <div class="ays_poll_layer_item">
                                        ...
                                        <div class="ays_poll_layer_item_title">
                                            ...
                                            <p>
                                            <!-- <a href="https://bit.ly/3P42n1R" style="font-size:12px;font-style: italic;" target="_blank">View demo</a> -->
                                            <a class="ays_poll_view_demo_link" href="https://poll-plugin.com/versus-poll-versus-type/" style="font-size:15px;" target="_blank">View demo</a>
                                            <i class="ays_poll_fas ays_poll_fa_play" aria-hidden="true"></i>
                                        </div>
                                        <div class="ays_poll_layer_item_description"></div>  
                                    </div>
                                    ...
                                    <div class="ays_poll_layer_item">
                                     ...
                                     alt="<?= __('Range', $this->plugin_name) ?>">
                                        ...
                                        <div class="ays_poll_layer_item_title">
                                            ...
                                            <p>
                                            <!-- <a href="https://bit.ly/3P42n1R" style="font-size:12px;font-style: italic;" target="_blank">View demo</a> -->
                                            <a class="ays_poll_view_demo_link" href="https://poll-plugin.com/slider-rating-polls-slider-type/" style="font-size:15px;" target="_blank">View demo</a>
                                            <i class="ays_poll_fas ays_poll_fa_play" aria-hidden="true"></i>
                                        </div>
                                        <div class="ays_poll_layer_item_description"></div>  
                                    </div>
