(function ($) {
    ...
    if ($('#ays-poll-allow-not-vote').prop('checked')) {
        $('.if-allow-not-vot').fadeIn();
    }
    $('#ays-poll-allow-not-vote').on('change', function () {
        $('.if-allow-not-vot').fadeToggle();
    });

    // Enable Vote button
    if ($('#ays_enable_vote_button').prop('checked')) {
        $('.if-enable-vote-button').fadeIn();
    }
    $('#ays_enable_vote_button').on('change', function () {
        $('.if-enable-vote-button').fadeToggle();
    });
