   ...
   <div class="container">
      <div class="inner-page-heading-in">
         <div class="left-inner-head">
            <h1 class="m-0"><?php echo get_the_title(10); ?></h1>
         </div>
   ...
   <div class="container">
      <div class="row">
        ...
        <?php endif; wp_reset_query(); ?>
         ...
         <div class="col-md-6">
            <div class="all-blogs">
            <div class="pop-all-tags category-tag position-relative">
                     <span>
               ...
               $buttom_posts_count = $total_posts - 13;
               $view_btn_count = ceil($buttom_posts_count / 4);
               $view_btn_click = $view_btn_count - 1;
               if($total_posts>13){
               ?>
      ...
      <?php endif; wp_reset_query(); ?>
      <!-- ==================== Load blog slice End ===================== -->
         <?php if($view_btn_click>0){ ?>
         <div class="text-center blog-slice-btn" data-viewclick="<?php echo $view_btn_click; ?>">
